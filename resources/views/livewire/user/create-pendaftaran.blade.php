                    ...
                    <form class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="inputState" class="form-control">
                                ...
                                <option value="Perempuan">Administrasi Perkantoran</option>
                                <option value="Perempuan">Komputer Akutasni</option>
                                <option value="Perempuan">Tekni Sepeda Motor</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label for="inputState" class="form-label">No.Telp/WA</label>
