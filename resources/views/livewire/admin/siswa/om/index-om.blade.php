<div class="containert">
    @if($statusDetail)
        @livewire('admin.siswa.om.detail-om')
    @endif
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Data Siswa Office Management</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            @if(count($CalonSiswa) !== 0)
                <a href="{{ route('exportSiswaOm') }}" target="_blank" class="btn btn-danger mb-2"><i class="fas fa-file-pdf fa-1x"></i></a>
            @endif
            <br>
            <div class="row mb-2">
                <div class="col-sm-8">
